...
ITEM(DataTypeByte,    1,  sizeof(char),       GL_BYTE,           true, true, true, true)
ITEM(DataTypeUByte,   1,  sizeof(char),       GL_UNSIGNED_BYTE,  true, true, true, true)
ITEM(DataTypeShort,   1,  sizeof(short),      GL_SHORT,          true, true, true, true)
ITEM(DataTypeUShort,  1,  sizeof(short),      GL_UNSIGNED_SHORT, true, true, true, true)
ITEM(DataTypeInt,     1,  sizeof(int),        GL_INT,            true, true, true, true)
ITEM(DataTypeUInt,    1,  sizeof(int),        GL_UNSIGNED_INT,   true, true, true, true)
...
ITEM(DataTypeTexFboC, 1,  0, 0, false, false, false, true)
ITEM(DataTypeTexFboD, 1,  0, 0, false, false, false, true)
