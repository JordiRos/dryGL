...
public:
    ...
    std::vector<glm::vec2> &GetTexCoords0       () { return m_TexCoords0; }
    std::vector<glm::vec2> &GetTexCoords1       () { return m_TexCoords1; }
    std::vector<glm::vec2> &GetTexCoords2       () { return m_TexCoords2; }
    std::vector<glm::vec2> &GetTexCoords3       () { return m_TexCoords3; }
...
protected:
    ...
    std::vector<glm::vec2>  m_TexCoords3;
